...
class ServiceTypeController extends BaseController
{
    ...
    public function __construct(ServiceBodyType $province, LogsRepository $logsRepository)
    {
        parent::__construct();
        $this->model = new CommonRepository($province);
    ...
    {
        try {
            $data['page_url'] = 'serviceType';
            $data['page_route'] = 'serviceType';
            $data['load_js'] = [
            ...
            return view('backend.dcc.serviceType.index', $data);
        } catch (\Exception $e) {
