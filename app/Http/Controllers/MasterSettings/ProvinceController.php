...
class ProvinceController extends BaseController
{
    ...
    public function __construct(Province $province, LogsRepository $logsRepository)
    {
        parent::__construct();
    ...
    {
        try {
            $data['page_url'] = '/provinces';
            $data['page_route'] = 'provinces';
            $data['load_js'] = [
                'js/custom_app.min.js',
            ];
            $data['page_title'] = getLan() == 'np' ? 'प्रदेश' : 'Province';
            ...
            return view('backend.masterSettings.province.index', $data);
        } catch (\Exception $e) {
            Session::flash('server_error', Lang::get('message.commons.technicalError'));
