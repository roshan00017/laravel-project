...
const edit_date_from_bs = document.getElementById("edit_date_from_bs");
edit_date_from_bs.nepaliDatePicker({
  dateFormat: "YYYY-MM-DD",
  ndpYear: true,
  ndpMonth: true,
  ndpYearCount: 100,
  ...
  onChange: function () {
    const date = edit_date_from_bs.value;
    const arr = date.split("-");
    const bsToAd = NepaliFunctions.ConvertDateFormat(
      NepaliFunctions.BS2AD({
        year: arr[0],
    ...
    $("#edit_date_from_ad").val(bsToAd);
  },
});

const edit_date_to_bs = document.getElementById("edit_date_to_bs");
edit_date_to_bs.nepaliDatePicker({
  dateFormat: "YYYY-MM-DD",
  ndpYear: true,
  ndpMonth: true,
  ndpYearCount: 100,
  ...
  onChange: function () {
    const date = edit_date_to_bs.value;
    const arr = date.split("-");
    const bsToAd = NepaliFunctions.ConvertDateFormat(
      NepaliFunctions.BS2AD({
        year: arr[0],
    ...
    $("#edit_date_to_ad").val(bsToAd);
  },
});

$("#edit_date_from_bs").change(function () {
  convertBsToAd($(this).val(), "#edit_date_from_ad");
});

$("#edit_date_to_bs").change(function () {
  convertBsToAd($(this).val(), "#edit_date_to_ad");
});

$("#edit_date_from_ad").change(function () {
  convertAdToBs($(this).val(), "#edit_date_from_bs");
});

$("#edit_date_to_ad").change(function () {
  convertAdToBs($(this).val(), "#edit_date_to_bs");
});
