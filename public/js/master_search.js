...
$("document").ready(function () {
  ...
  const chalani_date_from_bs = document.getElementById("ddate_from_bs");
  chalani_date_from_bs.nepaliDatePicker({
    ...
    onChange: function () {
      const date = chalani_date_from_bs.value;
  ...
  const chalani_date_to_bs = document.getElementById("ddate_to_bs");
  chalani_date_to_bs.nepaliDatePicker({
    dateFormat: "YYYY-MM-DD",
    ndpYear: true,
    ndpMonth: true,
    ndpYearCount: 100,
    ...
    onChange: function () {
      const date = chalani_date_to_bs.value;
      const arr = date.split("-");
      const bsToAd = NepaliFunctions.ConvertDateFormat(
        NepaliFunctions.BS2AD({
          year: arr[0],
