...
$("#addForm").validate({
  rules: { name_np: { required: true }, name_en: { required: true } },
  messages: {
    name_en: { required: "अंग्रेजी नाम  अनिवार्य छ ।" },
    name_np: { required: "नेपाली नाम  अनिवार्य छ ।" },
  },
  errorElement: "span",
...
$('#showPdf').on('click',function(){
  ...
  window.open($('#searchForm').attr('action') + '?' + formData, '_blank');         
});
