            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 {{setFont()}}">
                        ...
                        {!! Form::text('code',null,
                        ['class'=>'form-control',
                        'placeholder'=>trans('scheduleType.code'),
                        'autocomplete'=>'off',
                        'required'
                        ])
                        !!}
                    ...
                    <div class="form-group col-md-6 {{setFont()}}">
                        ...
                        ['class'=>'form-control',
                        'placeholder'=>trans('scheduleType.name_np'),
                        'autocomplete'=>'off',
                        'required'
                        ])
                        !!}
                    ...
                    <div class="form-group col-md-6 {{setFont()}}">
                        ...
                        ['class'=>'form-control',
                        'placeholder'=>trans('scheduleType.name_en'),
                        'autocomplete'=>'off',
                        'required'
                        ])
                        !!}
