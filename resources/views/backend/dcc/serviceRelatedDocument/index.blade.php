...
@section('content')
    ...
    <div class="content-wrapper">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            >
                                ...
                                @if( $request->service_type_id !=null || $request->service_id !=null || $request->department_id !=null
                               )
                                    ...
                                    >
                                        ...
                                        @foreach($results as $key=>$data)
                                            ...
                                            <tr>
                                                ...
                                                <td class="{{setFont()}}">
                                                {{ getLan()=='np' ? @$data->serviceType->name_np : @$data->serviceType->name_en}} 
                                                </td>
                                                  
                                                <td class="{{setFont()}}">
                                                    {{ getLan()=='np' ? @$data->service->name_np  : @$data->service->name_en}}
                                                </td>
                                                <td>
                                                    {{$data->service_rate}}
                                                </td>
                                                ...
                                                <td>
                                                    {{getLan()=='np' ? @$data->department->name_np :  @$data->department->name_en}}
                                                </td>
                                            ...
                                            @include('backend.dcc.serviceRelatedDocument.show')
                                            @include('backend.dcc.serviceRelatedDocument.edit_modal')
        ...
        @include('backend.dcc.serviceRelatedDocument.add_modal')
        @include('backend.dcc.serviceRelatedDocument.search_modal')
