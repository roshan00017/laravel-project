                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" style="text-align:right">
                                ...
                                || $request->module_name != null || $request->module_service_name != null || $request->fy_id != null)
                                    <a href="{{ url(@$page_url) }}"
                                        ...
                                        <tbody>
                                            @foreach ($results as $key => $data)
                                                <tr>
                                                    ...
                                                    <td class="{{setFont()}}">
                                                        @if (isset($data->module_service_name))
                                                            {{ moduleServiceName($data->module_service_name) }}
                                                        @endif
