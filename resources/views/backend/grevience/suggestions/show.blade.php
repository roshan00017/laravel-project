                        ...
                        <table class="table table-bordered table-striped">
                            <tbody>
                                ...
                                <tr class="detail-section {{ setFont() }}">
                                    ...
                                    <td width="80%">
                                        @if (isset($value->submit_date_np))
                                            {{ getLan() == 'np' ? $value->submit_date_np : $value->submit_date_en }}
                                ...
                                <tr class="detail-section {{ setFont() }}">
                                    ...
                                    <td width="80%">
                                        @if (isset($value->suggestion_categories))
                                            {{ getLan() == 'np' ? $value->suggestion_categories->name : $value->suggestion_categories->name_ne }}
                                        @endif
                                    </td>
                                </tr>
                                ...
                                <tr class="detail-section {{ setFont() }}">
                                    ...
                                    <td width="80%">
                                        @if (isset($value->files))
                                            <a href="{{ URL::to('/storage/' . $filePath . '/' . $value->files) }}"
