                            ...
                            <table id="example2" class="table table-bordered table-striped dataTable dtr-inline">
                                <thead class="th-header">
                                    <tr class="{{setFont()}}">
                                        ...
                                        <th>
                                            {{trans('appointmentStatus.code')}}
                                        </th>
                                        <th with="" 20%>
                                            {{ getLan() =='np' ? trans('appointmentStatus.appointment_name'):trans('appointmentStatus.appointment_name')}}
                                        </th>
                                        <th width="10%">
                                            {{trans('appointmentStatus.status')}}
                                        </th>
                                        <th width="10%">
                                ...
                                <tbody>
                                    ...
                                    @include('backend.basicDetails.appointmentStatus.edit')
                                    @endforeach
                                </tbody>
...
@include('backend.basicDetails.appointmentStatus.add')
