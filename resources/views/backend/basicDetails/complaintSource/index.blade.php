...
@section('content')
 ...
 <div class="content-wrapper">
                                ...
                                <div class="card-body">
                                    ...
                                    >
                                        ...
                                        <tr class="{{setFont()}}">
                                            ...
                                            <th>
                                            {{trans('complaintSource.source_name')}}
                                            </th>
                                            <th>
                                        ...
                                        @foreach($results as $key=>$data)
                                            <tr>
                                                ...
                                                <td>
                                                {{ getLan()=='np' ? $data->name : $data->name_ne}}
                                                </td>
                                                <td>
                                                    @if(isset($data->depth)) 
                                                        {{$data->depth}}
                                            ...
                                            @include('backend.basicDetails.complaintSource.edit')
        ...
        @include('backend.basicDetails.complaintSource.add')
