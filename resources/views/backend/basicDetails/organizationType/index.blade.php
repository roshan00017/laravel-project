...
<div class="content-wrapper">
                            ...
                            <table id="example2" class="table table-bordered table-striped dataTable dtr-inline">
                                <thead class="th-header">
                                    <tr class="{{setFont()}}">
                                        ...
                                        <th>
                                            {{ getLan() =='np' ? trans('organizationTypes.name_np'):trans('organizationTypes.name_en')}}
                                        </th>

                                        <th>
                                            {{trans('organizationTypes.details')}}
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    @include('backend.basicDetails.organizationType.edit')
                                    @endforeach
    ...
    @include('backend.basicDetails.organizationType.add')
