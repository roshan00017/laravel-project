...
@section('content')
    ...
    <div class="content-wrapper">
                                ...
                                <div class="card-body">
                                    ...
                                    >
                                        ...
                                        @foreach($results as $key=>$data)
                                            ...
                                            @include('backend.systemSetting.otpSetting.show')
                                            @include('backend.systemSetting.otpSetting.edit')
                                        @endforeach
                                        </tbody>
                                    </table>
                                    <span
        ...
        <!-- /.container-fluid -->
        <!-- /.content -->
        @include('backend.systemSetting.otpSetting.add')
        @include('backend.systemSetting.otpSetting.searchModal')
