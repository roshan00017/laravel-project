    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content modal-content-radius">
            ...
            <div class="modal-body">
                {!! Form::open(['method' => 'post', 'id' => 'addEmailForm', 'url' => $page_url]) !!}
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group-append">
                            <input type="password" name="mail_password" class="form-control" id='add-toggle-password'>
                            <div class="input-group-text">
                                <i class="fa fa-eye field-icon edit-toggle-password" toggle="#add-toggle-password"
                                    data-toggle="tooltip" title="Show Password">
                                </i>
                            </div>
                        </div>
