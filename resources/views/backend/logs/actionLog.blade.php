...
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right {{setFont()}}">
                            ...
                            <li class="breadcrumb-item">
                                {{trans('message.pages.logs_management.action_logs.sub_page_title')}}
                            </li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
                        ...
                        <div class="card">
                            ...
                            >
                                ...
                                >
                                    ...
                                    {{trans('message.pages.logs_management.action_logs.sub_page_title')}} {{trans('message.button.list')}}
                                </a>
                                ...
                                @if($request->user_id != null ||  $request->action_name != null   || $request->from_date != null || $request->to_date != null )
                                    <strong class="{{setFont()}}">  {{trans('message.pages.logs_management.action_logs.total_action')}} </strong>  <strong
                                ...
                                <div class="card-body">
                                    ...
                                    >
                                        ...
                                        <tr class="{{setFont()}}">
                                            ...
                                            <th width="150px;">
                                                {{trans('message.pages.logs_management.action_logs.action_by')}}
                                            </th>
                                            <th width="150px;">
                                            ...
                                            <th width="150px;">
                                                {{trans('message.pages.logs_management.action_logs.module_name')}}
                                            </th>
                                            <th width="120px;">
                                                {{trans('message.pages.logs_management.action_logs.action_name')}}
                                            </th>
                                            <th width="150px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if(isset($data->menuName))
                                                        <strong
                                                                class="badge badge-secondary {{setFont()}}">{{getLan() =='np'? $data->menuName->menu_name_np : $data->menuName->menu_name}}</strong>
                                                    @else
                                                ...
                                                <td class="{{setFont()}}">
                                                    ...
                                                    @elseif($data->action_name == '2' || $data->action_name == '5' || $data->action_name == '7' || $data->action_name == '8' || $data->action_name == '9')
    ...
    @include('backend.logs.action_search_modal')
