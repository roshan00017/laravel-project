...
@section('content')
 ...
 <div class="content-wrapper">
                                    ...
                                    >
                                        ...
                                        @foreach($results as $key=>$data)
                                            <tr>
                                                ...
                                                <td>
                                                @if(isset($data->meeting_member->name_en))
                                                            {{$data->meeting_member->name_en}}
                                                        @endif
                                                </td>
                                                <td>
                                                @if(allowShow())
                                            ...
                                            @include('backend.meetingManagement.finalVerdict.show')
                                            @include('backend.meetingManagement.finalVerdict.edit')
        ...
        <!-- /.container-fluid -->
        <!-- /.content -->
        @include('backend.meetingManagement.finalVerdict.searchModal')
        @include('backend.meetingManagement.finalVerdict.add')
