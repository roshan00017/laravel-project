...
@section('content')
    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        {{ trans('message.pages.category.page_title') }}
                        </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right {{setFont()}}">
                            ...
                            <li class="breadcrumb-item">
                                <a href="javascript:void(0);">
                                    {{trans('message.pages.category.category_name')}}
                                </a>
                            </li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        >
                                            ...
                                            <tr>
                                                ...
                                                @include('backend.meetingManagement.meetingCategory.edit_modal')
                                            @endforeach
                                            </tbody>
                                        </table>
                                        <span
        ...
        <!-- /.container-fluid -->
        <!-- /.content -->
        @include('backend.meetingManagement.meetingCategory.add')
