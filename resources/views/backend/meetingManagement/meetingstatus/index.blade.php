...
@section('content')
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 {{setFont()}}">
                            {{trans('meeting.meeting.meeting_title')}}
                        </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        >
                                            ...
                                            @foreach($results as $key=>$data)
                                                ...
                                                @include('backend.meetingManagement.meetingstatus.edit_modal')
                                            @endforeach
                                            </tbody>
                                        </table>
                                        <span
        ...
        <!-- /.container-fluid -->
        <!-- /.content -->
        @include('backend.meetingManagement.meetingstatus.add_modal')
