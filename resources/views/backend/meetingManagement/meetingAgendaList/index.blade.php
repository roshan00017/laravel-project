...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 {{ setFont() }}">
                        {{ trans('meeting.meeting_agenda_list.page_title') }}
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header" style="text-align:right">
                            ...
                            @if ($request->title != null || $request->meeting_id != null)
                            ...
                            <table id="example2" class="table table-bordered table-striped dataTable dtr-inline">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (allowShow())
                                            <button type="button" class="btn btn-secondary btn-xs rounded-pill {{ setFont() }}" data-toggle="modal" data-target="#showModal{{ $key }}" data-placement="top" title="{{ trans('message.button.show') }}">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            @endif
                                            &nbsp;
                                            @if (allowEdit() && $data->meeting->meeting_status_id == 1)
                                            <button type="button" class="btn btn-info btn-xs rounded-pill {{ setFont() }}" data-toggle="modal" data-target="#editModal{{ $key }}" data-placement="top" title="{{ trans('message.button.edit') }}">
                                    ...
                                    @include('backend.meetingManagement.meetingAgendaList.show')
                                    @include('backend.meetingManagement.meetingAgendaList.edit')
                                    @endforeach
                                </tbody>
                                @include('backend.meetingManagement.meetingAgendaList.show')
                            </table>
    ...
    <!-- /.container-fluid -->
    <!-- /.content -->
    @include('backend.meetingManagement.meetingAgendaList.searchModal')
    @include('backend.meetingManagement.meetingAgendaList.add')
