...
<div class="content-wrapper">
                            ...
                            <table id="example2" class="table table-bordered table-striped dataTable dtr-inline">
                                <thead class="th-header">
                                    <tr class="{{setFont()}}">
                                        ...
                                        <th>
                                            {{trans('message.pages.common.parent_id')}}
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="f-kalimati">
                                            {{isset($data->name_np) ? $data->name_np : ''}}
                                        </td>
                                        <td>
                                    ...
                                    @include('backend.edmis.standingListType.edit_model')
                                    @include('backend.edmis.standingListType.show')
                                    @endforeach
                                </tbody>
                            </table>
    ...
    @include('backend.edmis.standingListType.add_model')
