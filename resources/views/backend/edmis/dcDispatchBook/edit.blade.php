...
<div class="content-wrapper">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 {{setFont()}}">
                                    ...
                                    {!! $errors->first('dispatch_date_ad', '<small
                                        class="text text-danger">:message</small>') !!}
                                </div>
                                ...
                                <div class="form-group col-md-3 {{setFont()}}">
                                    ...
                                    {!! $errors->first('letter_date_ad', '<small
                                        class="text text-danger">:message</small>') !!}
                                ...
                                <div class="form-group col-md-4 {{setFont()}}">
                                    ...
                                    {!! $errors->first('letter_upload', '<small
                                        class="text text-danger">:message</small>') !!}
                                    <br>
                                ...
                                <div class="form-group col-md-4  {{setFont()}}">
                                    ...
                                    {!! $errors->first('from_branch_id', '<small
                                        class="text text-danger">:message</small>') !!}
                                </div>
                                ...
                                <div class="row col-md-12" id="person-details">
                                    <div class="col-md-4 {{setFont()}}">
                                        ...
                                        {!! $errors->first('person_name', '<small
                                            class="text text-danger">:message</small>') !!}
                                    </div>
                                    <div class="col-md-4 {{setFont()}}">
                                        <label for="inputName" class="{{setFont()}}">
                                        ...
                                        {!! $errors->first('contact_address', '<small
                                            class="text text-danger">:message</small>') !!}
                                    </div>
                                    <div class="col-md-4 {{setFont()}}">
                                        <label for="inputName" class="{{setFont()}}">
                            ...
                            <div class="row col-md-12" id="office-details">
                                <div class="col-md-3 {{setFont()}}">
                                    ...
                                    {!! $errors->first('to_office_id', '<small
                                        class="text text-danger">:message</small>') !!}
                                </div>
                                ...
                                <div class="col-md-3 {{setFont()}}">
                                    ...
                                    {!! $errors->first('to_office_name', '<small
                                        class="text text-danger">:message</small>') !!}
                                </div>
                                <div class="col-md-3 {{setFont()}}">
                                    <label for="inputName">
                                    ...
                                    {!! $errors->first('to_office_address', '<small
                                        class="text text-danger">:message</small>') !!}
                                </div>
                                <div class="col-md-3 {{setFont()}}">
                                    <label for="inputName">
                                    ...
                                    {!! $errors->first('to_office_contact', '<small
                                        class="text text-danger">:message</small>') !!}
                                </div>
                            </div>
    ...
    <!-- /.container-fluid -->
    <!-- /.content -->
    {{-- @include('backend.basicDetails.mstOffice.edit') --}}
