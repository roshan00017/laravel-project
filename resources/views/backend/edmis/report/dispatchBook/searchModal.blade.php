                ...
                <div class="row {{setFont()}}">
                    ...
                    <div class="form-group col-md-4">
                        {!!Form::number('ward',
                            ...
                            'width'=>'100%',
                            'min'=>1,
                            'placeholder'=>trans('dispatchreport.dc_dispatch_book.ward_no')])
                        !!}
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        {!!Form::select('employee_id',
                           ...
                           ['class'=>'form-control select2',
                           'style'=>'width: 100%;','placeholder'=>
                           trans('dispatchreport.dc_dispatch_book.choose_employee')])
                        !!}
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        {!!Form::select('from_branch_id',
                           ...
                           ['class'=>'form-control select2',
                           'style'=>'width: 100%;','placeholder'=>
                           trans('dispatchreport.dc_dispatch_book.choose_branch')])
                        !!}
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        {!!Form::select('user_id',
                           ...
                           ['class'=>'form-control select2',
                           'style'=>'width: 100%;','placeholder'=>
                           trans('dispatchreport.dc_dispatch_book.choose_user')])
                        !!}
                    </div>
