            ...
            <div class="modal-body">
                ...
                <div class="row {{setFont()}}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        trans('dartakitabreport.dc_register_book.fiscal_year')])
                        !!}
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        'width'=>'100%',
                        'min'=>1,
                        'placeholder'=>trans('dartakitabreport.dc_register_book.ward_no')])
                        !!}
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        ['class'=>'form-control select2',
                        'style'=>'width: 100%;','placeholder'=>
                        trans('dartakitabreport.dc_register_book.choose_employee')])
                        !!}
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        ['class'=>'form-control select2',
                        'style'=>'width: 100%;','placeholder'=>
                        trans('dartakitabreport.dc_register_book.choose_branch')])
                        !!}
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        ['class'=>'form-control select2',
                        'style'=>'width: 100%;','placeholder'=>
                        trans('dartakitabreport.dc_register_book.choose_user')])
                        !!}
                    </div>
