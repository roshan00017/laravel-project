            ...
            <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="form-group col-md-4 {{setFont()}}">
                            ...
                            {!! Form::number('physical_year_id', $currentFyId, [
                                'class' => 'form-control',
                                'placeholder' => trans('message.pages.common.physical_year_id'),
                                'autocomplete' => 'off',
                                'required',
                                'step' => '1'
                            ]) !!}
                            {!! $errors->first('physical_year_id', '<small class="text text-danger">:message</small>') !!}
                        </div> --}}
