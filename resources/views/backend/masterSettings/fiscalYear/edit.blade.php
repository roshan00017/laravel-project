    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-content-radius">
            ...
            <div class="modal-body">
                ...
                'route'=>['fiscalYears.update',$data->id],
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 {{setFont()}}">
                        <label for="inputName">
                            {{ getLan() =='np' ? trans('message.pages.fiscal_year.description') : trans('message.pages.fiscal_year.description') }}
                        </label>
