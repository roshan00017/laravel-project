...
@section('content')
 ...
 <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                           ...
                           @include('backend.masterSettings.clientSetting.list')
                                    ...
                                    >
                                        ...
                                        @foreach($results as $key=>$data)
                                            <tr>
                                                ...
                                                <td>
                                                {{ getLan()=='np' ? $data->master_setting->name_np : $data->master_setting->name_en}}
                                                </td>
                                                @endif
                                                <td class="{{setFont()}}">
                                                ...
                                                <td>
                                                    @include('backend.masterSettings.clientSetting.action')
                                            ...
                                            @include('backend.masterSettings.clientSetting.edit')
                                            @include('backend.masterSettings.clientSetting.show')
        ...
        <!-- /.container-fluid -->
        <!-- /.content -->
        @include('backend.masterSettings.clientSetting.search')
        @include('backend.masterSettings.clientSetting.add')
